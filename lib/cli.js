...
function exec() {
  ...
  var commands = {
      '_updep': {
        action: function() { bob.internal('updep'); }
      },
      '_versionup': {
        action: function() { bob.internal('versionup'); }
      },
      '_versionup-minor': {
        action: function() { bob.internal('versionup', { type: 'minor' }); }
      },
      '_versionup-major': {
        action: function() { bob.internal('versionup', { type: 'major' }); }
      },
      '_template': {
        action: function() { bob.internal('template'); }
      }
    },
    options = [
      { 
